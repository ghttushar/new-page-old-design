...
export const MOCK_DECISIONS: Decision[] = [
  ...
  },
  {
    ...
    source: 'aan',
    sourceRef: { label: 'Aan · daily budget monitor', ts: now - 50 * MIN },
    valueCents: 340_000,
    valueKind: 'cost',
    cadence: 'daily',
  ...
  },
  {
    id: 'd-aan-automation',
    source: 'aan',
    sourceRef: { label: 'Aan · auto-optimization report', ts: now - 2 * HOUR },
    valueCents: 180_000,
    valueKind: 'gain',
    cadence: 'weekly',
    valueCaption: 'weekly ad spend savings',
    valueBasis: 'Aan automatically adjusted bids on 12 keywords in the "Brand Defense" campaign. Average CPC reduced from $2.45 to $1.92 while maintaining impression share at 92%.',
    valueInputs: ['Keywords optimized: 12', 'CPC reduction: $2.45 → $1.92', 'Impression share maintained: 92%'],
    insight: 'Aan adjusted bids on 12 keywords in "Brand Defense" - CPC dropped 22% while impression share held at 92%.',
  ...
  },
  {
    id: 'd-buybox-loss',
    source: 'aan',
    sourceRef: { label: 'Aan · BuyBox monitor', ts: now - 1.5 * HOUR },
    valueCents: 650_000,
    valueKind: 'at_risk',
    valueCaption: 'monthly revenue at risk',
