...
export default function AdvertisingWalmartSVAccountLevelPlatform() {
  ...
  const setSelectedColumnsHandler = (
    ...
    columnFilterUtils.syncStoredColumnFilters(
      WalmartSVAccountLevelTitles.PLATFORM,
      selectedColumns
    );
  ...
  useEffect(() => {
    ...
    dispatch(
      setSelectedAdvertisingNavTitle(WalmartSVAccountLevelTitles.PLATFORM)
    );
  }, [dispatch]);
  ...
  const fetchPlatform = useAppQuery({
    queryKey: [
      QueryKeyEnums.WMT_SV_ACCOUNT_LVL_PLATFORM_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      walmartSvAdvertisingServices.getSVPlatform(
        ...
        paginationModel.pageIndex + 1,
        paginationModel.pageSize,
        getFormattedSortModel(WalmartSVAccountLevelTitles.PLATFORM, sortModel),
        searchText
      ),
    enabled:
      selectedAdvertisingNavTitle === WalmartSVAccountLevelTitles.PLATFORM,
  });
