...
import { IWalmartKeywords } from '@/interfaces/advertising/walmart/walmart-sp-advertising.interface';
import {
...
export default function AdvertisingWalmartSVAccountLevelKT() {
    ...
    options: {
      ...
      onSuccess: (response) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.WMT_SV_ACCOUNT_LVL_KT_FETCH],
        });
  ...
  const confirmEditSaveClick = async () => {
    ...
    const confirmClick = async () =>
      await handleReviewPopupConfirmClick(isReview, updatedKeywordTargetsBody);
  ...
  const fetchKeywordTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.WMT_SV_ACCOUNT_LVL_KT_FETCH,
      {
        appliedFilters,
