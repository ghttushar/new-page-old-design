...
export default function AdvertisingWalmartSPAccountLevelAdGroup() {
    ...
    options: {
      ...
      onSuccess: (response) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.WMT_SP_ACCOUNT_LVL_ADGROUP_FETCH],
        });
  ...
  useEffect(() => {
    ...
    dispatch(
      setSelectedAdvertisingNavTitle(WalmartSPAccountLevelTitles.AD_GROUPS)
    );
  }, [dispatch]);
  ...
  const fetchAdGroups = useAppQuery({
    queryKey: [
      QueryKeyEnums.WMT_SP_ACCOUNT_LVL_ADGROUP_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      walmartSpAdvertisingServices.getAdGroups(
        ...
        paginationModel.pageIndex + 1,
        paginationModel.pageSize,
        getFormattedSortModel(WalmartSPAccountLevelTitles.AD_GROUPS, sortModel),
        searchText
      ),
    enabled:
      selectedAdvertisingNavTitle === WalmartSPAccountLevelTitles.AD_GROUPS,
  });
