...
export default function AnalysisAdGroupsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      ...
      ImpactAnalysisTableTitles.AD_GROUP
    );
    dispatch(setSelectedAnalysisNavTab(selectedTab));
    dispatch(setSelectedAnalysisNavTitle(ImpactAnalysisTableTitles.AD_GROUP));
  }, [dispatch]);
  ...
  const fetchAnalysisGraphData = useAppQuery({
    ...
    enabled: selectedAnalysisNavTitle === ImpactAnalysisTableTitles.AD_GROUP,
  });
