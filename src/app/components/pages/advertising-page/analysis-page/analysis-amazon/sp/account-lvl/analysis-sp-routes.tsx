...
import AnalysisAdGroupsPage from './ad-groups/amz-sp-acct-lvl-ad-groups-analysis';
import AnalysisCampaignsPage from './campaigns/amz-sp-acct-lvl-campaigns-analysis';
import AnalysisKeywordsPage from './keywords/amz-sp-acct-lvl-keywords-analysis';
import AnalysisProductsPage from './products/amz-sp-acct-lvl-products-analysis';
import AnalysisSTRPage from './search-term/amz-sp-acct-lvl-str-analysis';
