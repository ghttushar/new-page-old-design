...
import { analysisAmzSPPerformanceOptions } from '@/constants/impact-analysis-filter.constants';
...
export default function AnalysisProductsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      analysisAmzSPPerformanceOptions,
  ...
  const fetchAnalysisGraphData = useAppQuery({
    queryFn: () => {
      return spAdvertisingServices.getPerformanceGraph(
        appliedFilters,
  ...
  const fetchAnalysisTableData = useAppQuery({
    queryFn: ({ signal }) => {
      return AnalysisSPService.getImpactAnalysisTable(
        appliedFilters,
        getAnalysisTableFilters(filters, MarketplaceEnum.AMAZON),
  ...
  return (
    <AnalysisRenderingComponents
      ...
      performanceNavigationTabOptions={analysisAmzSPPerformanceOptions}
