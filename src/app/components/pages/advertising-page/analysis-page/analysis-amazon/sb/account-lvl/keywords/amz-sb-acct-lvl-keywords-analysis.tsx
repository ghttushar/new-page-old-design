...
export default function AnalysisKeywordsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      ...
      ImpactAnalysisTableTitles.KEYWORDS
    );
    dispatch(setSelectedAnalysisNavTab(selectedTab));
    dispatch(setSelectedAnalysisNavTitle(ImpactAnalysisTableTitles.KEYWORDS));
  }, [dispatch]);
  ...
  const fetchAnalysisGraphData = useAppQuery({
    ...
    enabled: selectedAnalysisNavTitle === ImpactAnalysisTableTitles.KEYWORDS,
  });
