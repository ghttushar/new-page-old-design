...
import { analysisAmzSBPerformanceOptions } from '@/constants/impact-analysis-filter.constants';
...
import { sbAdvertisingServices } from '@/services/advertising/amazon/sb-advertising.service';
...
export default function AnalysisProductsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      analysisAmzSBPerformanceOptions,
  ...
  const fetchAnalysisGraphData = useAppQuery({
    queryFn: () => {
      return sbAdvertisingServices.getSBPerformanceGraph(
        appliedFilters,
  ...
  const fetchAnalysisTableData = useAppQuery({
    queryFn: ({ signal }) => {
      return AnalysisSBService.getImpactAnalysisTable(
        appliedFilters,
        getAnalysisTableFilters(filters, MarketplaceEnum.AMAZON),
  ...
  return (
    <AnalysisRenderingComponents
      ...
      performanceNavigationTabOptions={analysisAmzSBPerformanceOptions}
