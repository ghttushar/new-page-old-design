...
import AnalysisAdGroupsPage from './ad-groups/wmt-sp-acct-lvl-ad-groups-analysis';
import AnalysisCampaignsPage from './campaigns/wmt-sp-acct-lvl-campaigns-analysis';
import AnalysisKeywordsPage from './keywords/wmt-sp-acct-lvl-keywords-analysis';
import AnalysisProductsPage from './products/wmt-sp-acct-lvl-products-analysis';
import AnalysisSTRPage from './search-term/wmt-sp-acct-lvl-str-analysis';

export default function AnalysisSPRoutes() {
  return (
    <Routes>
      <Route
