...
import { analysisWmtSPPerformanceOptions } from '@/constants/impact-analysis-filter.constants';
...
export default function AnalysisProductsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      analysisWmtSPPerformanceOptions,
  ...
  const fetchAnalysisGraphData = useAppQuery({
    queryFn: () => {
      return walmartSpAdvertisingServices.getPerformanceGraph(
        appliedFilters,
  ...
  const fetchAnalysisTableData = useAppQuery({
    queryFn: () => {
      return WalmartAnalysisSPService.getImpactAnalysisTable(
        appliedFilters,
        getAnalysisTableFilters(filters, MarketplaceEnum.WALMART),
        selectedAnalysisNavTitle,
  ...
  return (
    <AnalysisRenderingComponents
      ...
      performanceNavigationTabOptions={analysisWmtSPPerformanceOptions}
