...
import AnalysisAdGroupsPage from './ad-groups/wmt-all-acct-lvl-ad-groups-analysis';
import AnalysisCampaignsPage from './campaigns/wmt-all-acct-lvl-campaigns-analysis';
import AnalysisKeywordsPage from './keywords/wmt-all-acct-lvl-keywords-analysis';
import AnalysisProductsPage from './products/wmt-all-acct-lvl-products-analysis';
import AnalysisSTRPage from './search-term/wmt-all-acct-lvl-str-analysis';
