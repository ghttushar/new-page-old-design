...
import { analysisWmtSVPerformanceOptions } from '@/constants/impact-analysis-filter.constants';
...
export default function AnalysisProductsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      analysisWmtSVPerformanceOptions,
  ...
  const fetchAnalysisGraphData = useAppQuery({
    queryFn: () => {
      return walmartSvAdvertisingServices.getSVPerformanceGraph(
        appliedFilters,
  ...
  const fetchAnalysisTableData = useAppQuery({
    queryFn: () => {
      return WalmartAnalysisSVService.getImpactAnalysisTable(
        appliedFilters,
        getAnalysisTableFilters(filters, MarketplaceEnum.WALMART),
        selectedAnalysisNavTitle,
  ...
  return (
    <AnalysisRenderingComponents
      ...
      performanceNavigationTabOptions={analysisWmtSVPerformanceOptions}
