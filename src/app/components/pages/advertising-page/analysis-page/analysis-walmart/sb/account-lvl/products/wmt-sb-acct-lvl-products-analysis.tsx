...
import { analysisWmtSBPerformanceOptions } from '@/constants/impact-analysis-filter.constants';
...
export default function AnalysisProductsPage() {
  ...
  useEffect(() => {
    ...
    const selectedTab = getSelectedNavTab(
      analysisWmtSBPerformanceOptions,
  ...
  const fetchAnalysisGraphData = useAppQuery({
    queryFn: () => {
      return walmartSbAdvertisingServices.getSBPerformanceGraph(
        appliedFilters,
  ...
  const fetchAnalysisTableData = useAppQuery({
    queryFn: () => {
      return WalmartAnalysisSBService.getImpactAnalysisTable(
        appliedFilters,
        getAnalysisTableFilters(filters, MarketplaceEnum.WALMART),
        selectedAnalysisNavTitle,
  ...
  return (
    <AnalysisRenderingComponents
      ...
      performanceNavigationTabOptions={analysisWmtSBPerformanceOptions}
