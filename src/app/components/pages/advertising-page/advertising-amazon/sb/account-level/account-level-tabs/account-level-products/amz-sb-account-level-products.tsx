...
export default function AdvertisingSBAccountLevelProductAds() {
  ...
  const setSelectedColumnsHandler = (
    ...
    columnFilterUtils.syncStoredColumnFilters(
      SbAccountLevelTitles.PRODUCT_ADS,
      selectedColumns
    );
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SB_ACCOUNT_LVL_PRODUCT_ADS_FETCH],
        });
    ...
    async (isDownload = false, isAllDownload = false) => {
      const res = sbAdvertisingAccountLevelServices
        .getProductAds(
          ...
          getFormattedSortModel(SbAccountLevelTitles.PRODUCT_ADS, sortModel),
          searchText
        )
        .then((res) => {
  ...
  const fetchProductAds = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_ACCOUNT_LVL_PRODUCT_ADS_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingAccountLevelServices.getProductAds(
        appliedFilters,
        getAmazonAdvertisingFilters(
          appliedAdvertisingFilters,
          appliedAdvertisingFilters.customDateRange,
    ...
    enabled: selectedAdvertisingNavTitle === SbAccountLevelTitles.PRODUCT_ADS,
  });
  ...
  useEffect(() => {
    ...
    dispatch(setSelectedAdvertisingNavTitle(SbAccountLevelTitles.PRODUCT_ADS));
  }, [dispatch]);
