...
export default function AdvertisingSBAccountLevelPT() {
  ...
  const setSelectedColumnsHandler = (
    ...
    columnFilterUtils.syncStoredColumnFilters(
      SbAccountLevelTitles.PRODUCT_TARGETING,
      selectedColumns
    );
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SB_ACCOUNT_LVL_PT_FETCH],
        });
  ...
  const fetchProductTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_ACCOUNT_LVL_PT_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingAccountLevelServices.getProductTargeting(
        appliedFilters,
        getAmazonAdvertisingFilters(
          appliedAdvertisingFilters,
          appliedAdvertisingFilters.customDateRange,
    ...
    enabled:
      selectedAdvertisingNavTitle === SbAccountLevelTitles.PRODUCT_TARGETING,
  });
  ...
  useEffect(() => {
    ...
    dispatch(
      setSelectedAdvertisingNavTitle(SbAccountLevelTitles.PRODUCT_TARGETING)
    );
  }, [dispatch]);
