...
export default function AdvertisingSBAccountLevelAdGroup() {
    ...
    options: {
      ...
      onSuccess: (response) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SB_ACCOUNT_LVL_ADGROUPS_FETCH],
        });
    ...
    async (isDownload = false, isAllDownload = false) => {
      const res = sbAdvertisingAccountLevelServices
        .getAdGroups(
          ...
          getFormattedSortModel(SbAccountLevelTitles.AD_GROUP, sortModel),
          searchText
        )
        .then((res) => {
  ...
  const fetchAdGroups = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_ACCOUNT_LVL_ADGROUPS_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingAccountLevelServices.getAdGroups(
        appliedFilters,
        getAmazonAdvertisingFilters(
          appliedAdvertisingFilters,
          appliedAdvertisingFilters.customDateRange,
    ...
    enabled: selectedAdvertisingNavTitle === SbAccountLevelTitles.AD_GROUP,
  });
  ...
  useEffect(() => {
    ...
    dispatch(setSelectedAdvertisingNavTitle(SbAccountLevelTitles.AD_GROUP));
  }, [dispatch]);
