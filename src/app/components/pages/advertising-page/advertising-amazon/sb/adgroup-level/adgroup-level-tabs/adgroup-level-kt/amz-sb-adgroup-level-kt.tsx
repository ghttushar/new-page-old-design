...
export default function AdvertisingSBAdGroupLevelKT<
...
>({
  ...
  useEffect(() => {
    ...
    dispatch(
      setSelectedAdvertisingNavTitle(SbAdGroupLevelTitles.KEYWORD_TARGETING)
    );
        ...
        .then((res) => {
          ...
          dispatch(
            showSuccessToastMessage({
              ...
              description: 'Keyword targeting data downloaded successfully.',
            })
          );
          return data;
        });
  ...
  const fetchKeywordTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_ADGROUP_LVL_KT_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingAdGroupLevelServices.getSBKeywordTargeting(
        appliedFilters,
        advertisingFiltersWithNoDownload,
        paginationModel.pageIndex + 1,
        paginationModel.pageSize,
    ...
    enabled:
      selectedAdvertisingNavTitle === SbAdGroupLevelTitles.KEYWORD_TARGETING,
  });
