...
export default function AdvertisingSBCampLevelNegPT<
...
>({
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SB_CAMPAIGN_LVL_NEG_PT_FETCH],
        });
        ...
        .then((res) => {
          ...
          dispatch(
            showSuccessToastMessage({
              ...
              description:
                'Negative Targeting Product downloaded successfully.',
            })
          );
          return data;
        });
  ...
  const fetchNegProductTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_CAMPAIGN_LVL_NEG_PT_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingCampaignLevelServices.getSBNegativeTargetingProduct(
        appliedFilters,
        advertisingFiltersWithNoDownload,
        paginationModel.pageIndex + 1,
        paginationModel.pageSize,
