...
export default function AdvertisingSBCampLevelProductAds<
...
>({
  ...
  const setSelectedColumnsHandler = (
    ...
    columnFilterUtils.syncStoredColumnFilters(
      SbCampaignLevelTitles.PRODUCT_ADS,
      selectedColumns
    );
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SB_CAMPAIGN_LVL_PRODUCT_ADS_FETCH],
        });
    ...
    async (isDownload = false, isAllDownload = false) => {
      const res = sbAdvertisingCampaignLevelServices
        .getSBProductAds(
          ...
          getFormattedSortModel(SbCampaignLevelTitles.PRODUCT_ADS, sortModel),
          searchText
        )
        .then((res) => {
  ...
  const fetchProductAds = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_CAMPAIGN_LVL_PRODUCT_ADS_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingCampaignLevelServices.getSBProductAds(
        appliedFilters,
        advertisingFiltersWithNoDownload,
        paginationModel.pageIndex + 1,
        paginationModel.pageSize,
    ...
    enabled: selectedAdvertisingNavTitle === SbCampaignLevelTitles.PRODUCT_ADS,
  });
  ...
  useEffect(() => {
    ...
    dispatch(setSelectedAdvertisingNavTitle(SbCampaignLevelTitles.PRODUCT_ADS));
