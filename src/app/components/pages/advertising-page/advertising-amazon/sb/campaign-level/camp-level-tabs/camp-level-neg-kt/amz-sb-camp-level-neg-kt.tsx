...
export default function AdvertisingSBCampLevelNegKT<
...
>({
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SB_CAMPAIGN_LVL_NEG_KT_FETCH],
        });
        ...
        .then((res) => {
          ...
          dispatch(
            showSuccessToastMessage({
              ...
              description:
                'Negative Targeting Keyword downloaded successfully.',
            })
          );
          return data;
        });
  ...
  const fetchNegKeywordTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SB_CAMPAIGN_LVL_NEG_KT_FETCH,
      {
        appliedFilters,
    ...
    queryFn: () =>
      sbAdvertisingCampaignLevelServices.getSBNegativeTargetingKeyword(
        appliedFilters,
        advertisingFiltersWithNoDownload,
        paginationModel.pageIndex + 1,
        paginationModel.pageSize,
