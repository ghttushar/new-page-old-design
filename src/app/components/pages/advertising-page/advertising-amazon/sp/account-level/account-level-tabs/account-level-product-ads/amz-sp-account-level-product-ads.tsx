...
export default function AdvertisingAccountLevelProductAds() {
  ...
  const setSelectedColumnsHandler = (
    ...
    columnFilterUtils.syncStoredColumnFilters(
      SpAccountLevelTitles.PRODUCT_ADS,
      selectedColumns
    );
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SP_ACCOUNT_LVL_PRODUCT_ADS_FETCH],
        });
  ...
  useEffect(() => {
    ...
    dispatch(setSelectedAdvertisingNavTitle(SpAccountLevelTitles.PRODUCT_ADS));
  }, [dispatch]);
    ...
    async (isDownload = false, isAllDownload = false) => {
      const res = spAdvertisingServices
        .getProductAds(
          ...
          getFormattedSortModel(SpAccountLevelTitles.PRODUCT_ADS, sortModel),
          searchText
        )
        .then((res) => {
  ...
  const fetchProductAds = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SP_ACCOUNT_LVL_PRODUCT_ADS_FETCH,
      {
        appliedFilters,
    ...
    enabled: selectedAdvertisingNavTitle === SpAccountLevelTitles.PRODUCT_ADS,
  });
  ...
  return (
    <AdvertisingRenderingComponents
      ...
      exportFileTitle={genExportFileName('amazon-sp', 'Product_Ads')}
