...
export default function AdvertisingAccountLevelKT() {
    ...
    options: {
      onSuccess: (response) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SP_ACCOUNT_LVL_KT_FETCH],
        });
  ...
  useEffect(() => {
    ...
    dispatch(
      setSelectedAdvertisingNavTitle(SpAccountLevelTitles.KEYWORD_TARGETING)
    );
  }, [dispatch]);
  ...
  const fetchKeywordTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SP_ACCOUNT_LVL_KT_FETCH,
      {
        appliedFilters,
    ...
    enabled:
      selectedAdvertisingNavTitle === SpAccountLevelTitles.KEYWORD_TARGETING,
  });
  ...
  return (
    <AdvertisingRenderingComponents
      ...
      exportFileTitle={genExportFileName('amazon-sp', 'Keyword_Targeting')}
