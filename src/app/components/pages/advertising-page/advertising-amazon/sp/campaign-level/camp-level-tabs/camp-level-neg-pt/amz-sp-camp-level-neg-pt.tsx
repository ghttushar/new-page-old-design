...
export default function AdvertisingCampLevelNegPT<T extends ICampaign | null>({
  campaignId,
    ...
    options: {
      ...
      onSuccess: (data) => {
        queryClient.invalidateQueries({
          queryKey: [
            QueryKeyEnums.AMZ_SP_CAMPAIGN_LVL_NEG_TARGETING_PRODUCT_FETCH,
          ],
        });
  ...
  const getCampLevelNegativeProductTargetingDownload = useCallback(
  ...
  const handleDownload = useCallback(
    async (isAllDownload: boolean) => {
      ...
      const data: Record<string, unknown>[] =
        (await getCampLevelNegativeProductTargetingDownload(
          true,
          isAllDownload
    ...
    [dispatch, getCampLevelNegativeProductTargetingDownload]
  );
