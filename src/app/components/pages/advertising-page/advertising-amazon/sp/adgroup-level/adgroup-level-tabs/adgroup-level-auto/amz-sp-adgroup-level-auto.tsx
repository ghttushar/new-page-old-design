...
export default function AdvertisingAdgrpLevelAuto<
...
>({
  ...
  const setSelectedColumnsHandler = (
    ...
    columnFilterUtils.syncStoredColumnFilters(
      SpAdGroupLevelTitles.TARGETING,
      selectedColumns
    );
    ...
    options: {
      onSuccess: (response) => {
        queryClient.invalidateQueries({
          queryKey: [QueryKeyEnums.AMZ_SP_ADGROUP_LVL_AUTO_FETCH],
        });
  ...
  useEffect(() => {
    ...
    dispatch(setSelectedAdvertisingNavTitle(SpAdGroupLevelTitles.TARGETING));
  }, [dispatch, updatedPerformanceOptions]);

  const getAdGroupAutoTargetingDownload = useCallback(
    async (isDownload = false, isAllDownload = false) => {
      const res = spAdvertisingServices
        .getAutoTargeting(
          ...
          getFormattedSortModel(SpAdGroupLevelTitles.TARGETING, sortModel),
          searchText
        )
        .then((res) => {
          ...
          dispatch(
            showSuccessToastMessage({
              ...
              description: 'Auto Targets downloaded successfully.',
            })
          );
          return data;
        });
  ...
  const fetchAutoTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SP_ADGROUP_LVL_AUTO_FETCH,
      {
        appliedFilters,
    ...
    enabled: selectedAdvertisingNavTitle === SpAdGroupLevelTitles.TARGETING,
  });
  ...
  const handleDownload = useCallback(
    async (isAllDownload: boolean) => {
      ...
      const data: Record<string, unknown>[] =
        (await getAdGroupAutoTargetingDownload(
          true,
          isAllDownload
    ...
    [dispatch, getAdGroupAutoTargetingDownload]
  );
  ...
  return (
    <AdvertisingRenderingComponents
      ...
      exportFileTitle={genExportFileName('amazon-sp', 'Auto Targeting')}
