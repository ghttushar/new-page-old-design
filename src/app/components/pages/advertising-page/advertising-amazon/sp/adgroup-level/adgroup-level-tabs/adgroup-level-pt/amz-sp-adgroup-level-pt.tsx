...
export default function AdvertisingAdgrpLevelPT<
...
>({
  ...
  const confirmEditSaveClick = async () => {
    ...
    const body: IEditAccessProductTargetingUpdateBody = {
  ...
  useEffect(() => {
    ...
    dispatch(
      setSelectedAdvertisingNavTitle(SpAdGroupLevelTitles.PRODUCT_TARGETING)
    );
  }, [dispatch, updatedPerformanceOptions]);

  const getAdGroupProductTargetingDownload = useCallback(
        ...
        .then((res) => {
          ...
          dispatch(
            showSuccessToastMessage({
              ...
              description: 'Product Targets downloaded successfully.',
            })
          );
          return data;
        });
  ...
  const fetchProductTargeting = useAppQuery({
    queryKey: [
      QueryKeyEnums.AMZ_SP_ADGROUP_LVL_PT_FETCH,
      {
        appliedFilters,
    ...
    enabled:
      selectedAdvertisingNavTitle === SpAdGroupLevelTitles.PRODUCT_TARGETING,
  });
  ...
  const handleDownload = useCallback(
    async (isAllDownload: boolean) => {
      ...
      const data: Record<string, unknown>[] =
        (await getAdGroupProductTargetingDownload(
          true,
          isAllDownload
    ...
    [dispatch, getAdGroupProductTargetingDownload]
  );
  ...
  return (
    <AdvertisingRenderingComponents
      ...
      exportFileTitle={genExportFileName('amazon-sp', 'Product Targeting')}
